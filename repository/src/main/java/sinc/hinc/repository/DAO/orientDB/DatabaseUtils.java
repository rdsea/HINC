...
public class DatabaseUtils {
    ...
    static Class[] clazzes = {IoTUnit.class, MicroService.class, DataPoint.class, ControlPoint.class, CloudConnectivity.class, ExecutionEnvironment.class, NetworkService.class};
